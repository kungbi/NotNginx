...
int CgiExecuter::run(RouteResult routerResult, const std::string& queryString, const std::string& requestMethod, const std::string& requestBody) {
    CgiRequestData requestData(routerResult, queryString, requestMethod, requestBody);
